...
public class ListScreen extends ListActivity {
	...
	String classes[] = { "ListScreen", "MainActivity", "Coordinates", "Maps", "Pushing", "Fourth", "Layout", "Prefactivity", "ProximityAlertActivity", "Prefworks", "LocationEx01", "LocationExample2"  };

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setListAdapter(new ArrayAdapter<String>(ListScreen.this, android.R.layout.simple_list_item_1, classes));
	}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Class ourClass = Class.forName("com.example.lbs2." + cheese);
		Intent ourIntent = new Intent(ListScreen.this, ourClass);
