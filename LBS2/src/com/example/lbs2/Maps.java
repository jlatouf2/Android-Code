...
public class Maps extends Activity implements LocationListener {
	...
	private static final String LOGIN_URL = "http://192.168.1.148:8888/AndroidPHP/addlocation.php";
	...
	class AttemptLogin extends AsyncTask<String, String, String> {
       ...
       //    String password = pass.getText().toString();
           ...
           Log.d("request!", password);
            ...
            String post_title3 = TextView05.getText().toString();
           ...
           try {
               ...
               if (success == 1) {
               	...
               	/*
					...
					Intent i = new Intent(Maps.this, Nextpage.class);
					finish();
					startActivity(i);
					*/
       ...
       protected void onPostExecute(String file_url) {
           ...
           pDialog.dismiss();
           if (file_url != null){
           	Toast.makeText(Maps.this, file_url, Toast.LENGTH_LONG).show();
           }
