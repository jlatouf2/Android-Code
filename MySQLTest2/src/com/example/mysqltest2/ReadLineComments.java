...
public class ReadLineComments extends ListActivity {
/*
 * WHAT WAS CHANGED:
 * 1)Added the SimpleAdapter adapter; at top
 * 2)Added adapter = new SimpleAdapter near bottom where needed to getString from adapter
 * 3)Added intent to button click so that you go to another screen (and bring intent data with you)
 */
   ...
   // private static final String READ_COMMENTS_URL = "http://xxx.xxx.x.x:1234/webservice/comments.php";
    ...
    //testing on Emulator:
   // private static final String READ_COMMENTS_URL = "http://192.168.1.110:8888/LWebservice/res/comments.php";
  ...
  //JSON IDS:
   ...
   //An array of all of our comments
    ...
    {
        Intent i = new Intent(ReadLineComments.this, Lines.class);
        startActivity(i);
    }
	...
	private void updateList() {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent i2 = new Intent(ReadLineComments.this,
						Lines.class);
				...
				Log.d("This is debug", "This grabs the info at the position:" + item3 + "it.");
		        startActivity(i2);
    ...
    public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ReadLineComments.this);
