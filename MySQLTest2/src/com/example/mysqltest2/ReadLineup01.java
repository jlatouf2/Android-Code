...
public class ReadLineup01 extends Activity {
	...
	private static final String READ_COMMENTS_URL = "http://192.168.1.110:8888/AndroidPHP/readlineup.php";
	...
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			mProgressDialog = new ProgressDialog(ReadLineup01.this);
	...
	private void updateList() {
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent i2 = new Intent(ReadLineup01.this, Lines.class);
