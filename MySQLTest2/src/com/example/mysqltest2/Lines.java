...
public class Lines extends Activity implements OnClickListener{
   ...
   // private static final String POST_COMMENT_URL = "http://192.168.1.110:8888/LWebservice/res/addcomment.php";
    private static final String POST_COMMENT_URL = "http://192.168.1.110:8888/AndroidPHP/lines.php";
  ...
  //testing from a real server:
	...
	class PostComment extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Lines.this);
		...
		protected String doInBackground(String... args) {
            ...
            SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(Lines.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            if (file_url != null){
            	Toast.makeText(Lines.this, file_url, Toast.LENGTH_LONG).show();
            }
