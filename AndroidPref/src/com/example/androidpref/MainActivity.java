...
public class MainActivity extends ListActivity {
	...
	String classes[] = { "SimplePrefsDemo", "PassIntent01", "LineupBeginController", "Splash", "Lineup04", "ListParse02",
	"example6"};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Class ourClass = Class.forName("com.example.androidpref." + cheese);
