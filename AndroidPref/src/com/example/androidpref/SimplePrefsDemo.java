...
package com.example.androidpref;
...
//Note: This gets the references from the preferences xml file and shows info on this activity
public class SimplePrefsDemo extends Activity {
	...
	public void onResume() {
		...
		//sets the text on the screen of what you selected in preferences xml file:
