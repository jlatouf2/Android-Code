package com.example.mysqltest4;
...
public class MainActivity extends ListActivity {
	...
	String classes[] = { "Login", "Register", "AddComment", "Splash", "Lineup04", "ListParse02",
	"example6"};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Class ourClass = Class.forName("com.example.mysqltest4." + cheese);
