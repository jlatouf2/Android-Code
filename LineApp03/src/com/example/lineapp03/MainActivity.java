...
import android.widget.ListView;
	...
	public class MainActivity extends ListActivity {
		...
		String classes[] = { "Lineupworks01", "PassIntent01", "LineupBeginController", "ActionBar01", "Lineup04", "ListParse02",
		"example6"};
		...
		protected void onListItemClick(ListView l, View v, int position, long id) {
			...
			Class ourClass = Class.forName("com.example.lineapp03." + cheese);
