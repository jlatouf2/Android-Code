...
public class Pushing extends Activity implements LocationListener {
	...
	class PostComment extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				if (success == 1) {
					 ...
					 * //finish(); return json.getString(TAG_MESSAGE);
					 */
				} else {
		...
		protected void onPostExecute(String file_url) {
			...
			pDialog.dismiss();
			if (file_url != null) {
				Toast.makeText(Pushing.this, file_url, Toast.LENGTH_LONG)
						.show();
			}
